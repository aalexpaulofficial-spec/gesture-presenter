...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/MASTER PRESENTER LOGO WITH BG.png" },
      { name: "twitter:image", content: "/MASTER PRESENTER LOGO WITH BG.png" },
    ...
    links: [
      ...
      { rel: "icon", href: "/MASTER PRESENTER OFFICIAL LOGO WITH BG.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/MASTER PRESENTER OFFICIAL LOGO WITH BG.png" },
